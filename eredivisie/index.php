...
<!DOCTYPE html>
    ...
    <body>
        <header class="main-header">
            ...
            <div id="contact-knop">
                <a href="contact/contact.php">Contact</a><br>
                <a href="login/login.php" id="loginbutton">Inloggen/registreren</a><br>
                <a href="login/logout.php" id="logoutbutton" class="btn btn-danger ml-3">Uitloggen</a>
            </div>
